...
class AudioCoding:
    ...
    def __init__(
        ...
        quantize_modules: Union[List[str], None] = ["Linear"],
        ...
        qconfig_spec = set([getattr(torch.nn, q) for q in quantize_modules]) if quantize_modules else None
        ...
        if quantize_model:
            ...
            for module in model.modules():
                if hasattr(module, 'weight_g') and hasattr(module, 'weight_v'):
                    ...
                    print(f"{module}: Removed weight norm for quantization")
